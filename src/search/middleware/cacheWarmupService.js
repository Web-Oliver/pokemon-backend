...
class CacheWarmupService {
  ...
  async warmupByEntityType(entityType, limit = 10) {
    ...
    try {
      switch (entityType) {
        case 'sets':
          Model = (await import('@/pokemon/sets/Set.js')).default;
          searchField = 'setName';
          break;
        case 'cards':
          Model = (await import('@/pokemon/cards/Card.js')).default;
          searchField = 'cardName';
          break;
        case 'products':
          Model = (await import('@/collection/items/SealedProduct.js')).default;
          searchField = 'name';
          break;
        case 'psa':
          Model = (await import('@/collection/items/PsaGradedCard.js')).default;
          searchField = 'cardName';
          break;
        default:

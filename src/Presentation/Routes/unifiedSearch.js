...
import { searchCacheMiddleware   } from '@/Presentation/Middleware/searchCache.js';
/**
...
router.get('/', searchCacheMiddleware(), searchController.search);
 ...
 */
router.get('/suggest', searchCacheMiddleware(), searchController.suggest);
 ...
 * @query   {string} sort - Sort criteria as JSON string (optional)
 */
router.get('/cards', searchCacheMiddleware(), searchController.searchCards);
 ...
 * @query   {string} sort - Sort criteria as JSON string (optional)
 */
router.get('/products', searchCacheMiddleware(), searchController.searchProducts);
 ...
 * @query   {string} sort - Sort criteria as JSON string (optional)
 */
router.get('/sets', searchCacheMiddleware(), searchController.searchSets);
 ...
 * @query   {string} sort - Sort criteria as JSON string (optional)
 */
router.get('/set-products', searchCacheMiddleware(), searchController.searchSetProducts);
 ...
 */
router.get('/cards/:cardId/related', searchCacheMiddleware(), searchController.getRelatedCards);
 ...
 */
router.get('/products/:productId/related', searchCacheMiddleware(), searchController.getRelatedProducts);

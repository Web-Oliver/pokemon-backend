...
const exportToDba = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    CentralizedErrorHandler.handle('DBA_EXPORT', 'DBA export generation', error, {
...
const downloadDbaZip = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    CentralizedErrorHandler.handle('DBA_EXPORT', 'DBA ZIP download', error, {
...
const postToDba = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    CentralizedErrorHandler.handle('DBA_POST', 'DBA integration and posting', error, {
      itemCount: items.length,
      dryRun,
      customDescription: customDescription?.length || 0
    });
...
const getDbaStatus = asyncHandler(async (req, res) => {
  try {
    ...
    CentralizedErrorHandler.handle('DBA_STATUS', 'DBA status retrieval', error);
  }
});
...
const testDbaIntegration = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    CentralizedErrorHandler.handle('DBA_TEST', 'DBA integration test', error, {
      testItemCount: collectionItems.length
    });
  }
});

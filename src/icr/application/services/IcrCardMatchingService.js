            ...
            for (const scan of scans) {
                try {
                    ...
                    if (parsingResult.success && parsingResult.bestMatch) {
                        ...
                        // CRITICAL FIX: Update failed matches to 'matched' status too - don't skip them!
                        result.matchingStatus = 'no_match';
                        ...
                        await this.gradedCardScanRepository.update(scan._id, {
                            ...
                            matchConfidence: 0,
                            matchingStatus: 'no_match',
                            processingStatus: 'matched' // STILL SET TO MATCHED so it appears in results
                        });
                    }

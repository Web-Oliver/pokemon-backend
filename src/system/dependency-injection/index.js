...
import SetProductRepository from '@/pokemon/products/SetProductRepository.js';
...
class Container {
  ...
  initialize() {
    ...
    // Register card service that wraps repository to provide expected interface
    this.registerFactory('cardService', (container) => {
      ...
      return {
        ...
        getById: async (id, options = {}) => {
          return await cardRepository.findById(id, options);
        },
        create: async (data) => {

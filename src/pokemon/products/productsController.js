...
const getAllProducts = (req, res, next) => getController().getAll(req, res, next);
const getProductById = (req, res, next) => getController().getById(req, res, next);
const getProductSetNames = (req, res, next) => getController().getSetNames(req, res, next);
...
export const getProductsController = getController;

...
class CacheWarmupService {
  ...
  async warmupByEntityType(entityType, limit = 10) {
    ...
    try {
      switch (entityType) {
        case 'sets':
          Model = (await import('@/Domain/Entities/Set.js')).default;
          searchField = 'setName';
          break;
        case 'cards':
          Model = (await import('@/Domain/Entities/Card.js')).default;
          searchField = 'cardName';
          break;
        case 'products':
          Model = (await import('@/Domain/Entities/SealedProduct.js')).default;
          searchField = 'name';
          break;
        case 'psa':
          Model = (await import('@/Domain/Entities/PsaGradedCard.js')).default;
          searchField = 'cardName';
          break;
        default:

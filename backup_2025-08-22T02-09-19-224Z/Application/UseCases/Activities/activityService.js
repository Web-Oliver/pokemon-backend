...
import { Activity, ACTIVITY_TYPES, ACTIVITY_PRIORITIES   } from '@/Domain/Entities/Activity.js';
import ActivityHelpers from '@/Infrastructure/Utilities/ActivityHelpers.js';
...
class ActivityService {
  ...
  static async generateHistoricalActivities() {
    ...
    try {
      const PsaGradedCard = (await import('@/Domain/Entities/PsaGradedCard.js')).default;
      const RawCard = (await import('@/Domain/Entities/RawCard.js')).default;
      const SealedProduct = (await import('@/Domain/Entities/SealedProduct.js')).default;
      const Auction = (await import('@/Domain/Entities/Auction.js')).default;

...
class ImportValidators {
  ...
  static validateSetData(setData, source = 'unknown') {
    ...
    if (setInfo.year) {
      const year = parseInt(setInfo.year);
    ...
    if (setInfo.total_cards) {
      const totalCards = parseInt(setInfo.total_cards);
    ...
    if (setInfo.unique_set_id) {
      const uniqueSetId = parseInt(setInfo.unique_set_id);
    ...
    if (totalGrades) {
      ...
      for (const gradeField of gradeFields) {
        if (totalGrades[gradeField] !== undefined) {
          const gradeValue = parseInt(totalGrades[gradeField]);
      ...
      if (totalGrades.total_graded !== undefined) {
        const calculatedTotal = gradeFields.slice(0, -1) // Exclude total_graded
          .reduce((sum, field) => sum + (parseInt(totalGrades[field]) || 0), 0);
        
        const reportedTotal = parseInt(totalGrades.total_graded);
    ...
    return {
      ...
      year: parseInt(setInfo.year),
      setUrl: setInfo.url,
      totalCardsInSet: parseInt(setInfo.total_cards),
      uniqueSetId: parseInt(setInfo.unique_set_id),
      total_grades: {
        grade_1: parseInt(totalGrades.grade_1) || 0,
        grade_2: parseInt(totalGrades.grade_2) || 0,
        grade_3: parseInt(totalGrades.grade_3) || 0,
        grade_4: parseInt(totalGrades.grade_4) || 0,
        grade_5: parseInt(totalGrades.grade_5) || 0,
        grade_6: parseInt(totalGrades.grade_6) || 0,
        grade_7: parseInt(totalGrades.grade_7) || 0,
        grade_8: parseInt(totalGrades.grade_8) || 0,
        grade_9: parseInt(totalGrades.grade_9) || 0,
        grade_10: parseInt(totalGrades.grade_10) || 0,
        total_graded: parseInt(totalGrades.total_graded) || 0
      }
    };
  }
  ...
  static validateCardData(cardData, uniqueSetId, source = 'unknown') {
    ...
    if (!cardData.unique_pokemon_id) {
      ...
      const uniquePokemonId = parseInt(cardData.unique_pokemon_id);
    ...
    if (cardData.grades) {
      ...
      for (const gradeField of gradeFields) {
        if (cardData.grades[gradeField] !== undefined) {
          const gradeValue = parseInt(cardData.grades[gradeField]);
          if (isNaN(gradeValue) || gradeValue < 0) {
    ...
    return {
      ...
      uniquePokemonId: parseInt(cardData.unique_pokemon_id),
      uniqueSetId: uniqueSetId,
      grades: {
        grade_1: parseInt(cardData.grades?.grade_1) || 0,
        grade_2: parseInt(cardData.grades?.grade_2) || 0,
        grade_3: parseInt(cardData.grades?.grade_3) || 0,
        grade_4: parseInt(cardData.grades?.grade_4) || 0,
        grade_5: parseInt(cardData.grades?.grade_5) || 0,
        grade_6: parseInt(cardData.grades?.grade_6) || 0,
        grade_7: parseInt(cardData.grades?.grade_7) || 0,
        grade_8: parseInt(cardData.grades?.grade_8) || 0,
        grade_9: parseInt(cardData.grades?.grade_9) || 0,
        grade_10: parseInt(cardData.grades?.grade_10) || 0,
        grade_total: parseInt(cardData.grades?.grade_total) || 0
      }
    };
  }
  ...
  static validateSetProductData(productData, source = 'unknown') {
    ...
    if (!productData.uniqueSetProductId) {
      ...
      const uniqueSetProductId = parseInt(productData.uniqueSetProductId);
    ...
    return {
      ...
      uniqueSetProductId: parseInt(productData.uniqueSetProductId)
    };
  }
  ...
  static validateProductData(productData, source = 'unknown') {
    ...
    if (!productData.uniqueProductId) {
      ...
      const uniqueProductId = parseInt(productData.uniqueProductId);
    ...
    if (productData.available !== undefined) {
      ...
      const availableNum = parseInt(availableStr);
    ...
    if (productData.available) {
      const availableStr = productData.available.toString().replace(/[^\d]/g, '');
      availableNum = parseInt(availableStr) || 0;
    }
    ...
    return {
      ...
      url: productData.url || '',
      uniqueProductId: parseInt(productData.uniqueProductId),
      setProductName: productData.setProductName.trim()
    };
  }

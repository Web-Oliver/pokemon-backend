...
const OptimizedSetProductImporter = require('./OptimizedSetProductImporter');
const OptimizedSetImporter = require('./OptimizedSetImporter');
const OptimizedProductImporter = require('./OptimizedProductImporter');
const OptimizedCardImporter = require('./OptimizedCardImporter');

// Import models for connection
require('../../models/Set');
require('../../models/Card');
require('../../models/SetProduct');
...
module.exports = OptimizedMainImporter;
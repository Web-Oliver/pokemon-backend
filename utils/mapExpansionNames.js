...
class ExpansionNameMapper {
  ...
  async processAllFiles() {
    ...
    fs.writeFileSync(detailedReportPath, JSON.stringify(detailedReport, null, 2), 'utf8');
    console.log(`\n📄 Detailed report saved: ${detailedReportPath}`);

    // Save simple list
    const simpleListPath = path.join(__dirname, '../data/expansion-names-list.json');
    fs.writeFileSync(simpleListPath, JSON.stringify(simpleList, null, 2), 'utf8');
...
module.exports = ExpansionNameMapper;